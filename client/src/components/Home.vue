  ...
  <div id="bck-image">
    <nav>
      <ul class="navlist">
        ...
        <li class="naveltLi">
          <a href="https://github.com/Axel-Duval" class="navelt">SOURCE CODE</a>
        </li>
      </ul>
    </nav>
    ...
    <div class="h100">
      ...
      <div class="div-title">
        ...
        <p class="text-muted-one">
          ...
          libero sed neque condimentum, sit amet mollis lacus auctor. In
          tincidunt magna est, sed eleifend diam eleifend quis. Quisque ornare
          pretium purus a accumsan. Maecenas elit ante, luctus eget justo porta,
          varius tempor mauris.
        </p>
      </div>
    ...
    <div class="h100 middle" id="focal">
      ...
      <div class="wrapper">
        ...
        <div class="container">
          ...
          <p class="text-muted-one">
            Nulla ornare risus in ante molestie, ut finibus est aliquet. Morbi
            vel odio porttitor, consequat orci ut, fringilla velit. Vivamus
            porttitor libero sed neque condimentum, sit amet mollis lacus
            auctor. In tincidunt magna est, sed eleifend diam eleifend quis.
            Quisque ornare pretium purus a accumsan. Maecenas elit ante, luctus
            ege.
          </p>
        </div>
      </div>
    ...
    <footer>
      ...
      <p class="text-muted-two">
        Logos : Flaticon | ChatAnywhere &#8480; 2020-2021 | Picture :
        Unsplash(Rendiansyah Nugroho)
      </p>
    </footer>
  </div>
</template>
